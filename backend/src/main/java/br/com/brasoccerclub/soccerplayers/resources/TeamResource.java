...
import br.com.brasoccerclub.soccerplayers.services.TeamService;
...
public class TeamResource {
	...
	@GetMapping
	public ResponseEntity<Page<TeamDTO>> findAll(@RequestParam(value = "page", defaultValue = "0") Integer page,
