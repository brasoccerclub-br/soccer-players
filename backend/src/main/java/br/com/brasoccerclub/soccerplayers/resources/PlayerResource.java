...
import br.com.brasoccerclub.soccerplayers.services.PlayerService;
...
public class PlayerResource {
	...
	@GetMapping
	public ResponseEntity<Page<PlayerDTO>> findAll(@RequestParam(value = "page", defaultValue = "0") Integer page,
	...
	@GetMapping(value = "/{id}")
	public ResponseEntity<PlayerDTO> findById(@Valid @PathVariable Long id) {
